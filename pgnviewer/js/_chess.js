...
function Board(divId, options) {
  ...
  this.opts['blackSqColor'] = '#3D9970';
  this.opts['whiteSqColor'] = '#FFFFFF';
  this.opts['sqHighlightWhite'] = 'img/backgrounds/lightsquare-highlight.svg';
  this.opts['sqHighlightBlack'] = 'img/backgrounds/darksquare-highlight.svg';
  this.opts['moveFontSize'] = "11pt";
  this.opts['moveFontColor'] = 'darkgreen';
  this.opts['moveFont'] = '"Helvetica Neue", Helvetica, Arial, sans-serif';
  this.opts['background'] = '#fff';

  this.opts['commentFontSize'] = "10pt";
  this.opts['commentFontColor'] = "#006699";
  this.opts['commentFont'] = '"Helvetica Neue", Helvetica, Arial, sans-serif';

  this.opts['boardSize'] = '257px';
  this.opts['squareSize'] = '48px';
  this.opts['pieceSize'] = '48px';
  this.opts['buttonSize'] = '32px';
  ...
  this.opts['markLastMoveColor'] = "#FFFF00";
  ...
  let pgnLength = this.conv.pgn.moves.length;
  this.opts['skipToMove'] = pgnLength * 2;
  ...
  this.init = function () {
    ...
    var side = document.getElementById('side').innerText;
    if (side.trim() == 'black') {
      this.opts['flipped'] = true;
    }
    var jump = document.getElementById('jump').innerText;
    if (jump.trim()) {
      this.opts['skipToMove'] = Number(jump);
    }
    ...
    boardFrame.addEventListener('keydown', function (event) {
      ...
      else if (key == "k" || key == 37) {
        that.makeBwMove();
      }
    }, false);

    boardFrame.addEventListener('wheel', function (event) {
      if (event.defaultPrevented) {
        return;
      }
      if (event.deltaY > 0) {
    ...
    buttonsRow.setAttribute('name', 'buttons');
    topTableTb.appendChild(buttonsRow).appendChild(btnTd);
  ...
  this.markLastMove = function () {
    ...
    try {
      ...
      if (piece.style.background) {
        ...
        //}
        piece.style.background = this.opts['markLastMoveColor'];
      }
      else {
  ...
  deMakeBold = function (el) {
    ...
    rtrn.style.color = this.brd.opts['moveFontColor'];
    //rtrn.style.color = this.opts['moveFontColor'];
    return rtrn;
  };
  ...
  this.populateMoves = function (cont, pgn) {
    ...
    for (var i = 0; i < tmp2.length; i++) {
      if (tmp2[i].white != null) {
        ...
        tmp3 = document.createElement("num");

        //tmp3.style.fontFamily = this.opts['moveFont'];
        //tmp3.style.fontSize = this.opts['moveFontSize'];
        //tmp3.style.color = "black";
        //tmp3.style.textAlign = "right";
        //tmp3.style.width = 30;
        //tmp3.style.display = "inline-block";
        //tmp3.style.marginRight = 10;
